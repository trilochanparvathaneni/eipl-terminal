      ...
      <TabsList className="h-auto w-full justify-start rounded-none border-b border-slate-200 bg-transparent p-0">
        {items.map((item) => (
          <TabsTrigger
            ...
            value={item.value}
            className={cn(
              "relative rounded-none border-b-2 border-transparent px-3 py-2 text-xs font-medium text-slate-500",
              "data-[state=active]:border-blue-600 data-[state=active]:bg-transparent data-[state=active]:text-slate-900 data-[state=active]:shadow-none"
            )}
          >
